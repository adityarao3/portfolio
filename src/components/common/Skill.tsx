...
export default function Skill({ name, href, children }: SkillProps) {
  ...
  return (
    <span className="skill-inner-shadow inline-flex items-center self-end rounded-md border border-dashed border-black/20 bg-black/5 px-2 py-1 text-sm text-black dark:border-white/30 dark:bg-white/15 dark:text-white">
      {content}
    </span>
  );
}
